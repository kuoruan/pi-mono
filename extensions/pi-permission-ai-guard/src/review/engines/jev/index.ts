 ...
 *
 * Four calibrated questions (danger_category, intent_match,
 * unconditionally_safe, risk) ported from SAFETY_RULES; answers are
 * probabilities, never text, so deny reasons synthesize from the danger
 * category and low confidence defers like the LLM lean.
 *
